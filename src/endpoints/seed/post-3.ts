...
export const post3: (args: PostArgs) => RequiredDataFromCollectionSlug<'posts'> = ({
  ...
  return {
    ...
    layout: [
      {
        blockType: 'news_hero_section',
        featuredHeading: 'Dollar and Sense: The Financial Forecast',
        featuredTag: 'Finance',
                ...
                children: [
                  {
                    ...
                    mode: 'normal',
                    style: '',
                    text: "Money isn't just currency; it's a language. Dive deep into its nuances, where strategy meets intuition in the vast sea of finance.",
                    version: 1,
                  },
                ],
                direction: 'ltr',
